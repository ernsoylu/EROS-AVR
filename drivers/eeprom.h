 ...
 * Eep_Update busy-waits BEFORE the next byte (interrupts stay enabled -
 ...
 * Worst-case WCET of Eep_Update(len) = len * 3.4 ms + 3.4 ms: budget it,
...
/** 1 = no write in flight (Eep_ReadByte/Eep_UpdateByte return at their
