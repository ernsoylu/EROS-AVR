/**
 * @file    pwm.h
 * @brief   Timer1 fast-PWM driver (evolution of 06-PWM).
 *
 * 06-PWM offered Timer1 and Timer2 back-ends. Under TinyOS, Timer2 is
 * the kernel tick and MUST NOT be touched by drivers, so this driver is
 * Timer1-only: mode 14 (fast PWM, ICR1 = TOP), prescaler /8, 1 kHz on
 * OC1A / PB1 (Arduino Nano pin D9).
 *
