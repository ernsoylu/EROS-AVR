...
OS_STATIC_ASSERT((ALARM_CTRL < OS_NUM_ALARMS),
                 "alarm ID out of range");

OS_STATIC_ASSERT(OS_NUM_RESOURCES <= 8u, "resource held-mask is 8-bit");
OS_STATIC_ASSERT((RES_SHARED < OS_NUM_RESOURCES),
